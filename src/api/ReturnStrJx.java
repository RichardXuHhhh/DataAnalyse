...
public class ReturnStrJx {
	public String getAnalyseInfo() throws Exception{
		String str1=new String();
		try {
			URL url = new URL("https://pub.icaile.com/jx11x5/");
			URL url1 = new URL("https://pub.icaile.com/jx11x5/");
...
//			System.out.println("qishu:"+qishu);
			...
			{
				page=518+15*qishu+13-15;
			}else{
				page=518+15*qishu+26-15;
			}
			//qishu=84;
			line=0;
			int index1=0;
