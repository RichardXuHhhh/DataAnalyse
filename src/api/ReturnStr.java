...
public class ReturnStr {
    ...
    public String getAnalyseInfo() throws Exception{
        ...
        try {
            URL url = new URL("https://pub.icaile.com/sh11x5/");
            URL url1 = new URL("https://pub.icaile.com/sh11x5/");
            ...
            while ((str = bufr.readLine()) != null) {
                line=line+1;
                if(line>966&&line<980)
                {
                    count=0;
                    continue;
                }
                if(line>1429&&line<1443)
                {
                    count=0;
                    continue;
                }
